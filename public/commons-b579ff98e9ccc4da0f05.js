/*! For license information please see commons-b579ff98e9ccc4da0f05.js.LICENSE.txt */
        ...
        fe = u()(
          function (e) {
            return {
              ...
              linkTags: X(b.LINK, [L, E], e),
              metaTags: X(b.META, [T, y, k, A, S], e),
              noscriptTags: X(b.NOSCRIPT, [C], e),
              onChangeClientState: V(e),
              scriptTags: X(b.SCRIPT, [j, C], e),
              styleTags: X(b.STYLE, [w], e),
              title: $(e),
    ...
    7182: function (e, t, n) {
      ...
      const l = e => {
        ...
        const { pathname: s } = (0, i.useLocation)(),
          ...
          { defaultTitle: u, defaultDescription: d, siteUrl: f, defaultImage: m } = c.siteMetadata,
          p = { title: t || u, description: n || d, image: `${f}${l || m}`, url: `${f}${s}` };
        return r.createElement(
          a.m,
          { title: t, defaultTitle: p.title, titleTemplate: `%s | ${u}` },
          r.createElement('html', { lang: 'en' }),
          r.createElement('meta', { name: 'description', content: p.description }),
          r.createElement('meta', { name: 'image', content: p.image }),
          r.createElement('meta', { property: 'og:title', content: p.title }),
          r.createElement('meta', { property: 'og:description', content: p.description }),
          r.createElement('meta', { property: 'og:image', content: p.image }),
          r.createElement('meta', { property: 'og:url', content: p.url }),
          r.createElement('meta', { property: 'og:type', content: 'website' }),
          r.createElement('meta', { name: 'twitter:card', content: 'summary_large_image' }),
          r.createElement('meta', { name: 'twitter:title', content: p.title }),
          r.createElement('meta', { name: 'twitter:description', content: p.description }),
          r.createElement('meta', { name: 'twitter:image', content: p.image }),
          ...
          const a = [
            ...
            r.createElement(
              ...
              r.createElement(
                'p',
                null,
                'I am currently designing and shipping new features for an iOS app at my internship and exploring LLM integration in personal projects, using my background in mobile and backend development to better understand how these models can be applied in practice.',
                ' ',
              ),
            ),
            ...
            r.createElement(
              ...
              r.createElement(
                ...
                r.createElement(
                  'p',
                  null,
                  'Hi, I’m Andrew - I studied Computer Science, but most of what I’ve learned has come from building things on my own. For me, programming has never been about knowing everything it’s about learning by doing. I like working on projects that challenge me, collaborating with people who think differently, and seeing how far I can take an idea with code.',
                ),
                r.createElement(
                  'p',
                  null,
      ...
      const wt = c.default.ul.withConfig({
        ...
        Et = c.default.li.withConfig({
          ...
          [
            ...
            ';position:relative;z-index:2;padding:25px;border-radius:var(--border-radius);background-color:var(--light-navy);color:var(--light-slate);font-size:var(--fz-lg);text-align:left;@media (max-width:768px){padding:20px 0;background-color:transparent;box-shadow:none;&:hover{box-shadow:none;}}a{',
...
//# sourceMappingURL=commons-b579ff98e9ccc4da0f05.js.map
